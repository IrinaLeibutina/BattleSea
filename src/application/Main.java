...
public class Main extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    MenuItem allGames = new MenuItem("ВСЕ ИГРЫ");
    ...
    MenuItem sortForAllGames = new MenuItem("СОРТИРОВКА");
    MenuItem mapForAllGames = new MenuItem("КАРТА ИГРЫ");
    MenuItem sequence = new MenuItem("ПОСЛЕДОВАТЕЛЬНОСТИ");
